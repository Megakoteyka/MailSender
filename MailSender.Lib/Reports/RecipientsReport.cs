...
namespace GeneratedCode
{
    public class GeneratedClass
    {
        ...
        private void GenerateExtendedFilePropertiesPart1Content(ExtendedFilePropertiesPart extendedFilePropertiesPart1)
        {
            ...
            var template1 = new Ap.Template {Text = "Normal.dotm"};
            var totalTime1 = new Ap.TotalTime {Text = "5"};
            var pages1 = new Ap.Pages {Text = "1"};
            var words1 = new Ap.Words {Text = "13"};
            var characters1 = new Ap.Characters {Text = "75"};
            var application1 = new Ap.Application {Text = "Microsoft Office Word"};
            var documentSecurity1 = new Ap.DocumentSecurity {Text = "0"};
            var lines1 = new Ap.Lines {Text = "1"};
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            var paragraph1 = new Paragraph { RsidParagraphMarkRevision = "0050312C", RsidParagraphAddition = "0050312C", RsidParagraphProperties = "0050312C", RsidRunAdditionDefault = "0050312C" };
            ...
            var bold1 = new Bold();
            var fontSize1 = new FontSize { Val = "36" };
            var fontSizeComplexScript1 = new FontSizeComplexScript { Val = "36" };
            ...
            var run1 = new Run { RsidRunProperties = "0050312C" };

            var runProperties1 = new RunProperties();
            var bold2 = new Bold();
            var fontSize2 = new FontSize { Val = "36" };
            var fontSizeComplexScript2 = new FontSizeComplexScript { Val = "36" };

            runProperties1.Append(bold2);
            runProperties1.Append(fontSize2);
            runProperties1.Append(fontSizeComplexScript2);
            var text1 = new Text();
            text1.Text = "Список получателей";
            ...
            var gridColumn1 = new GridColumn { Width = "988" };
            var gridColumn2 = new GridColumn { Width = "4178" };
            var gridColumn3 = new GridColumn { Width = "4179" };

            tableGrid1.Append(gridColumn1);
            tableGrid1.Append(gridColumn2);
            tableGrid1.Append(gridColumn3);

            var tableRow1 = new TableRow { RsidTableRowMarkRevision = "0050312C", RsidTableRowAddition = "0050312C", RsidTableRowProperties = "0050312C" };

            var tableCell1 = new TableCell();

            var tableCellProperties1 = new TableCellProperties();
            var tableCellWidth1 = new TableCellWidth { Width = "988", Type = TableWidthUnitValues.Dxa };

            tableCellProperties1.Append(tableCellWidth1);

            var paragraph2 = new Paragraph { RsidParagraphMarkRevision = "0050312C", RsidParagraphAddition = "0050312C", RsidParagraphProperties = "0050312C", RsidRunAdditionDefault = "0050312C" };
            ...
            var fontSizeComplexScript3 = new FontSizeComplexScript { Val = "28" };
            ...
            var run2 = new Run { RsidRunProperties = "0050312C" };
            ...
            var tableCellWidth2 = new TableCellWidth { Width = "4178", Type = TableWidthUnitValues.Dxa };

            tableCellProperties2.Append(tableCellWidth2);

            var paragraph3 = new Paragraph { RsidParagraphMarkRevision = "0050312C", RsidParagraphAddition = "0050312C", RsidParagraphProperties = "0050312C", RsidRunAdditionDefault = "0050312C" };
            ...
            var fontSizeComplexScript5 = new FontSizeComplexScript { Val = "28" };
            ...
            var run3 = new Run { RsidRunProperties = "0050312C" };

            var runProperties3 = new RunProperties();
            var bold6 = new Bold();
            var fontSize6 = new FontSize { Val = "28" };
            var fontSizeComplexScript6 = new FontSizeComplexScript { Val = "28" };
            ...
            var tableCellWidth3 = new TableCellWidth { Width = "4179", Type = TableWidthUnitValues.Dxa };

            tableCellProperties3.Append(tableCellWidth3);

            var paragraph4 = new Paragraph { RsidParagraphMarkRevision = "0050312C", RsidParagraphAddition = "0050312C", RsidParagraphProperties = "0050312C", RsidRunAdditionDefault = "0050312C" };
            ...
            var bold7 = new Bold();
            var fontSize7 = new FontSize { Val = "28" };
            var fontSizeComplexScript7 = new FontSizeComplexScript { Val = "28" };
            ...
            var run4 = new Run { RsidRunProperties = "0050312C" };

            var runProperties4 = new RunProperties();
            var bold8 = new Bold();
            var fontSize8 = new FontSize { Val = "28" };
            var fontSizeComplexScript8 = new FontSizeComplexScript { Val = "28" };
            ...
            var tableRow2 = new TableRow { RsidTableRowMarkRevision = "0050312C", RsidTableRowAddition = "0050312C", RsidTableRowProperties = "0050312C" };

            var tableCell4 = new TableCell();

            var tableCellProperties4 = new TableCellProperties();
            var tableCellWidth4 = new TableCellWidth { Width = "988", Type = TableWidthUnitValues.Dxa };

            tableCellProperties4.Append(tableCellWidth4);

            var paragraph5 = new Paragraph { RsidParagraphMarkRevision = "0050312C", RsidParagraphAddition = "0050312C", RsidParagraphProperties = "0050312C", RsidRunAdditionDefault = "0050312C" };

            var paragraphProperties5 = new ParagraphProperties();

            var paragraphMarkRunProperties5 = new ParagraphMarkRunProperties();
            var fontSize9 = new FontSize { Val = "28" };
            var fontSizeComplexScript9 = new FontSizeComplexScript { Val = "28" };
            ...
            var run5 = new Run { RsidRunProperties = "0050312C" };

            var runProperties5 = new RunProperties();
            var fontSize10 = new FontSize { Val = "28" };
            var fontSizeComplexScript10 = new FontSizeComplexScript { Val = "28" };
            ...
            var tableCellWidth5 = new TableCellWidth { Width = "4178", Type = TableWidthUnitValues.Dxa };

            tableCellProperties5.Append(tableCellWidth5);

            var paragraph6 = new Paragraph { RsidParagraphMarkRevision = "0050312C", RsidParagraphAddition = "0050312C", RsidParagraphProperties = "0050312C", RsidRunAdditionDefault = "0050312C" };

            var paragraphProperties6 = new ParagraphProperties();

            var paragraphMarkRunProperties6 = new ParagraphMarkRunProperties();
            var fontSize11 = new FontSize { Val = "28" };
            var fontSizeComplexScript11 = new FontSizeComplexScript { Val = "28" };
            ...
            var run6 = new Run { RsidRunProperties = "0050312C" };

            var runProperties6 = new RunProperties();
            var fontSize12 = new FontSize { Val = "28" };
            var fontSizeComplexScript12 = new FontSizeComplexScript { Val = "28" };
            ...
            var run7 = new Run { RsidRunProperties = "0050312C" };

            var runProperties7 = new RunProperties();
            var fontSize13 = new FontSize { Val = "28" };
            var fontSizeComplexScript13 = new FontSizeComplexScript { Val = "28" };

            runProperties7.Append(fontSize13);
            runProperties7.Append(fontSizeComplexScript13);
            var text7 = new Text();
            text7.Text = "лучатель 1";
            ...
            var tableCellWidth6 = new TableCellWidth { Width = "4179", Type = TableWidthUnitValues.Dxa };

            tableCellProperties6.Append(tableCellWidth6);

            var paragraph7 = new Paragraph { RsidParagraphMarkRevision = "0050312C", RsidParagraphAddition = "0050312C", RsidParagraphProperties = "0050312C", RsidRunAdditionDefault = "0050312C" };

            var paragraphProperties7 = new ParagraphProperties();

            var paragraphMarkRunProperties7 = new ParagraphMarkRunProperties();
            var fontSize14 = new FontSize { Val = "28" };
            var fontSizeComplexScript14 = new FontSizeComplexScript { Val = "28" };
            ...
            var run8 = new Run { RsidRunProperties = "0050312C" };

            var runProperties8 = new RunProperties();
            var fontSize15 = new FontSize { Val = "28" };
            var fontSizeComplexScript15 = new FontSizeComplexScript { Val = "28" };
            var languages4 = new Languages { Val = "en-US" };

            runProperties8.Append(fontSize15);
            runProperties8.Append(fontSizeComplexScript15);
            runProperties8.Append(languages4);
            var text8 = new Text();
            text8.Text = "R1@mail.ru";
            ...
            var tableRow3 = new TableRow { RsidTableRowMarkRevision = "0050312C", RsidTableRowAddition = "0050312C", RsidTableRowProperties = "00214024" };

            var tableCell7 = new TableCell();

            var tableCellProperties7 = new TableCellProperties();
            var tableCellWidth7 = new TableCellWidth { Width = "988", Type = TableWidthUnitValues.Dxa };

            tableCellProperties7.Append(tableCellWidth7);

            var paragraph8 = new Paragraph { RsidParagraphMarkRevision = "0050312C", RsidParagraphAddition = "0050312C", RsidParagraphProperties = "00214024", RsidRunAdditionDefault = "0050312C" };

            var paragraphProperties8 = new ParagraphProperties();

            var paragraphMarkRunProperties8 = new ParagraphMarkRunProperties();
            var fontSize16 = new FontSize { Val = "28" };
            var fontSizeComplexScript16 = new FontSizeComplexScript { Val = "28" };
            ...
            var fontSize17 = new FontSize { Val = "28" };
            var fontSizeComplexScript17 = new FontSizeComplexScript { Val = "28" };
            ...
            var tableCellWidth8 = new TableCellWidth { Width = "4178", Type = TableWidthUnitValues.Dxa };

            tableCellProperties8.Append(tableCellWidth8);

            var paragraph9 = new Paragraph { RsidParagraphMarkRevision = "0050312C", RsidParagraphAddition = "0050312C", RsidParagraphProperties = "00214024", RsidRunAdditionDefault = "0050312C" };

            var paragraphProperties9 = new ParagraphProperties();

            var paragraphMarkRunProperties9 = new ParagraphMarkRunProperties();
            var fontSize18 = new FontSize { Val = "28" };
            var fontSizeComplexScript18 = new FontSizeComplexScript { Val = "28" };
            ...
            var fontSize19 = new FontSize { Val = "28" };
            var fontSizeComplexScript19 = new FontSizeComplexScript { Val = "28" };

            runProperties10.Append(fontSize19);
            runProperties10.Append(fontSizeComplexScript19);
            var text10 = new Text();
            text10.Text = "Получатель 2";
            ...
            var tableCellWidth9 = new TableCellWidth { Width = "4179", Type = TableWidthUnitValues.Dxa };

            tableCellProperties9.Append(tableCellWidth9);

            var paragraph10 = new Paragraph { RsidParagraphMarkRevision = "0050312C", RsidParagraphAddition = "0050312C", RsidParagraphProperties = "00214024", RsidRunAdditionDefault = "0050312C" };

            var paragraphProperties10 = new ParagraphProperties();

            var paragraphMarkRunProperties10 = new ParagraphMarkRunProperties();
            var fontSize20 = new FontSize { Val = "28" };
            var fontSizeComplexScript20 = new FontSizeComplexScript { Val = "28" };
            ...
            paragraphMarkRunProperties10.Append(languages5);

            paragraphProperties10.Append(paragraphMarkRunProperties10);

            var run11 = new Run { RsidRunProperties = "0050312C" };

            var runProperties11 = new RunProperties();
            var fontSize21 = new FontSize { Val = "28" };
            var fontSizeComplexScript21 = new FontSizeComplexScript { Val = "28" };
            var languages6 = new Languages { Val = "en-US" };

            runProperties11.Append(fontSize21);
            runProperties11.Append(fontSizeComplexScript21);
            runProperties11.Append(languages6);
            var text11 = new Text();
            text11.Text = "R";
            ...
            var fontSize22 = new FontSize { Val = "28" };
            var fontSizeComplexScript22 = new FontSizeComplexScript { Val = "28" };
            ...
            var run13 = new Run { RsidRunProperties = "0050312C" };

            var runProperties13 = new RunProperties();
            var fontSize23 = new FontSize { Val = "28" };
            var fontSizeComplexScript23 = new FontSizeComplexScript { Val = "28" };
            ...
            var paragraph11 = new Paragraph { RsidParagraphMarkRevision = "0050312C", RsidParagraphAddition = "007C6DFF", RsidParagraphProperties = "0050312C", RsidRunAdditionDefault = "0050312C" };

            var paragraphProperties11 = new ParagraphProperties();

            var paragraphMarkRunProperties11 = new ParagraphMarkRunProperties();
            var bold9 = new Bold();
            var fontSize24 = new FontSize { Val = "36" };
            var fontSizeComplexScript24 = new FontSizeComplexScript { Val = "36" };
            ...
            var sectionProperties1 = new SectionProperties { RsidRPr = "0050312C", RsidR = "007C6DFF" };
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
        {
            ...
            var rsidRoot1 = new RsidRoot { Val = "0050312C" };
            var rsid1 = new Rsid { Val = "0050312C" };
            var rsid2 = new Rsid { Val = "00791579" };
            var rsid3 = new Rsid { Val = "00B7322B" };
            ...
            var documentId1 = new W14.DocumentId { Val = "2DF1A09B" };
            var chartTrackingRefBased1 = new W15.ChartTrackingRefBased();
            var persistentDocumentId1 = new W15.PersistentDocumentId { Val = "{5CB7420A-2DAC-4A24-9F57-0E98441C24A0}" };
        ...
        private void GenerateStyleDefinitionsPart1Content(StyleDefinitionsPart styleDefinitionsPart1)
        {
            ...
            var fontSize25 = new FontSize { Val = "22" };
            var fontSizeComplexScript25 = new FontSizeComplexScript { Val = "22" };
            var languages9 = new Languages { Val = "ru-RU", EastAsia = "en-US", Bidi = "ar-SA" };

            runPropertiesBaseStyle1.Append(runFonts1);
            runPropertiesBaseStyle1.Append(fontSize25);
            runPropertiesBaseStyle1.Append(fontSizeComplexScript25);
            ...
            var style5 = new Style { Type = StyleValues.Table, StyleId = "a3" };
            var styleName5 = new StyleName { Val = "Table Grid" };
            var basedOn1 = new BasedOn { Val = "a1" };
            var uIPriority4 = new UIPriority { Val = 39 };
            var rsid4 = new Rsid { Val = "0050312C" };
        ...
        {
            var fonts = new Fonts { MCAttributes = new MarkupCompatibilityAttributes { Ignorable = "w14 w15 w16se" } };
            fonts.AddNamespaceDeclaration("mc", "http://schemas.openxmlformats.org/markup-compatibility/2006");
            fonts.AddNamespaceDeclaration("r", "http://schemas.openxmlformats.org/officeDocument/2006/relationships");
            fonts.AddNamespaceDeclaration("w", "http://schemas.openxmlformats.org/wordprocessingml/2006/main");
            fonts.AddNamespaceDeclaration("w14", "http://schemas.microsoft.com/office/word/2010/wordml");
            fonts.AddNamespaceDeclaration("w15", "http://schemas.microsoft.com/office/word/2012/wordml");
            fonts.AddNamespaceDeclaration("w16se", "http://schemas.microsoft.com/office/word/2015/wordml/symex");

            var fontCalibri = new Font { Name = "Calibri" };
            ...
            fontCalibri.Append(panose1Number1);
            fontCalibri.Append(fontCharSet1);
            fontCalibri.Append(fontFamily1);
            fontCalibri.Append(pitch1);
            fontCalibri.Append(fontSignature1);
            ...
            fonts.Append(fontCalibri);
            fonts.Append(font2);
            fonts.Append(font3);

            fontTablePart1.Fonts = fonts;
        }

        private void SetPackageProperties(OpenXmlPackage document)
        {
            document.PackageProperties.Creator = "Николай Макухин";
            document.PackageProperties.Title = "";
            document.PackageProperties.Subject = "";
            document.PackageProperties.Keywords = "";
            document.PackageProperties.Description = "";
            document.PackageProperties.Revision = "1";
            document.PackageProperties.Created = System.Xml.XmlConvert.ToDateTime("2020-02-20T16:58:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2020-02-20T17:03:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.LastModifiedBy = "Николай Макухин";
        }
